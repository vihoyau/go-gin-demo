...
CREATE TABLE `blog_article` (
    ...
    `deleted_on` int(10) unsigned DEFAULT '0' COMMENT '修改人',
    `state` tinyint(3) unsigned DEFAULT '1' COMMENT '删除时间',
    PRIMARY KEY (`id`)
) ENGINED = InnoDB DEFAULT CHARSET = utf8 COMMENT '文章管理';
...
CREATE TABLE `blog_auth` (
    ...
    PRIMARY KEY (`id`)
) ENGINED = InnoDB DEFAULT CHARSET = utf8 COMMENT '账号管理';
...
CREATE TABLE `blog_tag` (
    ...
    `state` tinyint(3) unsigned DEFAULT '1' COMMENT '状态：1启动，0禁用'
    PRIMARY KEY (`id`)
) ENGINED = InnoDB DEFAULT CHARSET = utf8 COMMENT '文章标签管理';
